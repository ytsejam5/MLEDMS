            ...
            <div class="col-lg-3 left-pane">
{
    mledms-utils:import-viewpart("/admin/security/parts/role-menu.xqy", $mledms-utils:request-attribute)
            ...
            <div class="col-lg-9 right-pane">
                <form class="form-horizontal" method="get" action="{mledms-utils:create-command-url("admin/security/role-parent-roles", ())}">
                    <fieldset>
                        <legend>上位ロール</legend>
                        <div class="row">
                ...
                <hr/>
                <form class="form-horizontal" method="post" action="{mledms-utils:create-command-url("admin/security/role-parent-roles-update", ())}">
                    <input type="hidden" name="role-id" value="{ $role-id }"/>
{
        ...
        return
                        <div class="row">
                            <div class="col-sm-offset-1 col-sm-2">
                                <label>
                                    <input type="hidden" name="parent-role-id" value="{ $role-id }"/>
